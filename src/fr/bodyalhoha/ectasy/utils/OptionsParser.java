...
public class OptionsParser {
	...
	// A set of boolean command-line arguments
	public HashSet<String> bools = new HashSet<String>();
	// A set of argument names that take a value
	public HashSet<String> has = new HashSet<String>();
	...
	public OptionsParser(String[] args, String[] has, String[] contains) {
		this.has = new HashSet<String> (Arrays.asList(has));
	...
	/**
	 * Returns true if the provided argument is present in the bools set,
	 * false otherwise
	...
	public boolean getBool(String arg) {
		// Check if the provided argument is present in the bools set
